...
//        }
    ...
    private void refreshTextView(int position, int curPosition, View
        ...
        if (textView.getTag() != null) {
            size = Float.valueOf((String) textView.getTag());
        }
...
////                    defTextSize);
            float textSize = mStyle.selectedTextZoom != -1 ? size * mStyle.selectedTextZoom : size;
            textView.setSelected(true);
            setTextView(itemView, textView, textSize, 1.0f);
        } else {    // 未选中
...
//                    WheelConstants.WHEEL_TEXT_SIZE;
            ...
            setTextView(itemView, textView, textSize, alpha);
        }
    }
     ...
     * @param textAlpha
     */
    private void setTextView(View itemView, TextView textView, float textSize, float textAlpha) {
